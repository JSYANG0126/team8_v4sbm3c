...
<form name='frm' method='post' action='/reply/update.do'>
  <input type='hidden' name='replyno' value="${replyVO.replyno }">
  <input type='hidden' name='reviewno' value="${replyVO.reviewno }">
  <div>
    <label>댓글</label>
    <input type="text" name="reply" value="${replyVO.reply}" required="required" autofocus="autofocus" 
