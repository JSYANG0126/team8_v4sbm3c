    ...
    <form name='frm_delete' id='frm_delete' method='post' action='./delete.do'>
      ...
      <c:choose>
        ...
        <c:otherwise> <%-- 자식 레코드가 없는 상황 --%>
          ...
          <button type="submit" id='submit' class='btnbtn-sm' style='height: 28px; margin-bottom: 5px; background-color: #323232; color:white;'>삭제</button>          
        </c:otherwise>
      </c:choose>      

      <button type="button" onclick="location.href='/genre/list_all.do'" class='btnbtn-sm' style='height: 28px; margin-bottom: 5px; background-color: #323232; color:white;'>취소</button>
    </form>
  </div>
