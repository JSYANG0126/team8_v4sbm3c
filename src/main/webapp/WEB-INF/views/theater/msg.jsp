...
%>
<div class='title_line'>영화관 페이지 > 알림</div>
<div class='message'>
  <fieldset class='fieldset_basic'>
    <ul>
        ...
        %>
          <li class="li_none">
            <span class="span_success">영화관을 등록했습니다.</span><br>
            등록된 영화관: <%=name %>
          </li>
        <%  
        ...
        %>
          <li class="li_none">
            <span class="span_fail">영화관 등록에 실패했습니다.</span><br>
            등록 실패된 예매 페이지: <%=name %>
          </li>
        <%  
        ...
        %>
          <li class="li_none">
            <span class="span_success">영화관 수정을 성공했습니다.</span><br>
            수정된 영화관 이름: <%=name %>
          </li>
        <%  
        ...
        %>
          <li class="li_none">
            <span class="span_fail">영화관 수정에 실패했습니다.</span><br>
            수정 실패된 영화관 이름: <%=name %>
          </li>
        <%  
        ...
        %>
          <li class="li_none">
            <span class="span_success">삭제를 성공했습니다.</span><br>
            삭제된 영화관명: <%=name %>
          </li>
        <%  
        ...
        %>
          <li class="li_none">
            <span class="span_fail">삭제에 실패했습니다.</span><br>
            삭제 실패된 영화관: <%=name %>
          </li>
        <%  
        } 
